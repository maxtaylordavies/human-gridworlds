    ...
    return (
      <Container fluid className="griddlyjs-ide-container">
        ...
        <Modal show={this.state.loading} backdrop="static">
          <Modal.Header>
            <Modal.Title className="loading-logo">
              <img alt="loading" src="logo_ai_white.png" height={70} />
            </Modal.Title>
          </Modal.Header>
          <Modal.Body className="loading-gif">
            ...
            <Nav>
              <NavItem>
                <a href="https://griddly.ai">
                  <img alt="Griddly Bear" src="logo_ai_white.png" height="40" />
                </a>
              </NavItem>
